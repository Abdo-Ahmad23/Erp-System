...
Date (26 April 2022)
-----------------------
-[FIX] Rounding not working with customer discount.
-[FIX] Customer discount and order discount not working

v15.0.24 (06 May 2022)
-----------------------
-[Update] make restaurant module compatible.

Date (12 May 2022)
-[ADD] Add partial payment feature

Date (13 May 2022)
- Make textbox readonly in bundle popup
- Solve issue that only discount reward is not work.


v15.0.25 (24 May 2022)
-------------------------------------------------
-[ADD] Pos Category Slider Added.

    Date => (02 June 2022)
    --------------------------------
    -[FIXED] product list view on hand count not proper.

(04 June 2022)
-------------------------------------------------
-[FIXED] Fixed issue when session close automatically

 
15.0.26 (08 June 2022)
-----------------------------------
[fixed] when search product which is not display in list at that time on hand qty not display
-[UPDATE] Display product template name if product have variant and variant feature is enable.

15.0.27 (10 June 2022)
----------------------------------
-[Fixed] When variant is Display as attribute bundle flow not working.

    Date (11 June 2022)
    ---------------------------
    -[fix] when selected store location is disble at a time in pos product list view on hand qty not display.

(22 June 2022)
--------------------
- If product have variant then not allow to set bundle and vice versa

(29 June 2022)
-----------------------
-[FIX] realtime stock update not working with Float value. it's conver value in integer.

Date(04 jul 2022)
--------------------------
-[FIX] FIX issue when change uom price it's change base unit price not gating current uom.

Date (07 Jul 2022)
-----------------------------
-[Fixed] Stock not update correct when product have lot

15.0.28 (Date 09 Jul 2022)
--------------------------------
-[ADD] Customer MAximum Discount feature Added.

Date (01 Jul 2022)
-------------------------------
-[fixed] reduce product loadtime when load pos.
 
 Date ( Date 03 Aug 2022)
--------------------------------
-[FIXED] in theme, when select button style as right side at a time kitchen screen dont show any control-buttons 

15.0.29 (Date 03 Aug 2022)
--------------------------------
-[ADD] Multi barcode functionality Added.
-[FIXED] hide suggestion product if product is not there.

Date ( 30 Aug 2022)
------------------------
-[FIXED] Display current session pos oredr only in pos payment popup.

15.0.30 (15 Sep 2022)
--------------------------------
-[FIX] Fix issue of auto lock that if press cancel then also it open product screen.

15.0.31 (01 Octomber 2022)
--------------------------------
-[Update] Make partial payment compatible with "Restrict Product Categories" feature.
-[FIX] stop creating point of sale option in res config settings
(04 October 2022)
----------------------------------
-[FIX] Fix freez screen issue when quick receipt print

(12 October 2022)
-------------------------------------
-[FIX] Attach order pdf when send by email

15.0.32 ( 15 October 2022)
-------------------------------------
- [FIX] Correct difference amount when user pay due amount of other session
- [FIX] update warehouse quantity on delete icon

Date (Oct 21 2022)
-------------------
-[FIXED] remove image_1920 field at loading time

Date (09 Nov 2022)
-----------------------
load multi barcode after some time bcz custom barcodes loaded before product load

Date(12 Nov 2022)
--------------------------
-[FIXED] in order list display Date/time base on timezone

Date (23 Nov 2022)
---------------------------
-[FIXED] _ not define done