...
per_partner = fields.Boolean("Per Partner")
...
class HrPayslip(models.Model):
    ...
    def action_payslip_done(self):
        ...
        payslips_to_post = payslips_to_post.filtered(lambda slip: slip.state == 'done' or not slip.move_id)
            ...
            for slip_date in slip_mapped_data[journal_id]:  # For each month.
                ...
                for slip in slip_mapped_data[journal_id][slip_date]:
                    ...
                    for line in slip.line_ids.filtered(lambda line: line.category_id):
                        ...
                        if line.salary_rule_id.per_partner:
                            print('################################################ in first if per_partner')
                            if emp_partner:
                                print('+++++++++++++++++++++++ in second if emp_partner')
                                if debit_account_id:  # If the rule has a debit account.
                                    ...
                                    if not debit_line:
                                        debit_line = {
                                            'name': slip.employee_id.name + ' / ' + line.salary_rule_id.name,
