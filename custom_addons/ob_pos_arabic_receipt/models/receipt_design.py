...
class ArabicReceiptDesign(models.Model):
    _name = "arabic.receipt"
    ...
    def _create_receipt_design_1(self):
            ...
            <div class='orderlines'>
                ...
                <table style="width: 100%;font-weight: bolder;">
                    ...
                    <tr t-foreach="receipt.orderlines" t-as="line"
                        style="font-weight: bolder;border-bottom: 3px solid #ddd;font-size:70%;">
                        <t t-set="linetaxamount" t-value="0"/>
                        <td style="padding-right: 2px;border:1px solid #ddd;">
                        ...
                        <td style="padding-right: 2px;border:1px solid #ddd;text-align: right;">
                            <div style="padding-top: 10px;padding-bottom: 10px;">
                                ...
                                <t t-if=" line.price != line.price_lst">
                                    ...
                                    <t t-set="discountlinerate"
                                       t-value="Math.round(((line.price_lst - line.price) / line.price_lst ) * 100 )"/>
                                    <t t-if="discountlinerate > 0">
                                        <h5 style="font-weight: bolder;text-align: right;margin-top: 0%;margin-bottom: 0%;font-size: 85%;color: #848484;">
                                            تخفيض<span t-esc='discountlinerate'
                                ...
                                <t t-if='line.discount !== 0'>
                                    ...
                                    <t t-set="linepriceafterdesc"
                                       t-value="(line.price - (line.discount / 100 ) * line.price)"/>
                                    <span t-esc="widget.pos.format_currency_no_symbol(linepriceafterdesc)"/>
                                </t>
                            </div>
                        </td>
                        <td style="padding-right: 2px;border:1px solid #ddd;text-align: right;">
                            <span t-esc='widget.pos.format_currency_no_symbol(line.price_without_tax)'/>
                        </td>
                        <td style="padding-right: 2px;border:1px solid #ddd;text-align: right;">
                            <span t-esc='widget.pos.format_currency_no_symbol(line.tax)'/>
                        </td>
                        <td style="padding-right: 2px;border:1px solid #ddd;text-align: right;">
                            <span t-esc='widget.pos.format_currency_no_symbol(line.price_with_tax)'/>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        if record_id and pos_config_id:
            pos_config_id.enable_arabic_receipt = True
