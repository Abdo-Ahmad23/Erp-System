...
class PosConfig(models.Model):
    ...
    pos_switch_view = fields.Boolean(string="Enable Product Switch View")
    sh_default_view = fields.Selection([('list_view', 'List View'), ('grid_view', 'Grid View')], default="grid_view",
    ...
    sh_product_image_size = fields.Selection(
        [('small_size', 'Small Size'), ('medium_size', 'Medium Size'), ('large_size', 'Large Size')],
        default="medium_size", string="Image Size")
