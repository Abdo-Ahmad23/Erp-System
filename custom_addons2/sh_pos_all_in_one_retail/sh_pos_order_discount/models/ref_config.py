...
class Posconfig(models.Model):
    ...
    sh_line_discount_or_custom_discount = fields.Selection(
        [('line_discount', 'Simple Line Discount'), ('custom_discount', 'Custom Discount')], default='line_discount',
        string='Standard Discount Type')
